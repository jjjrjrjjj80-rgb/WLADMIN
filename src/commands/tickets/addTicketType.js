...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const pingRole = interaction.options.getRole('رتبة_المنشن'); // ⭐ جديد
...
await TicketType.create({ key, label, categoryId: category.id, emoji, pingRoleId: pingRole ? pingRole.id : null }); // ⭐ عدّلت هذا السطر
